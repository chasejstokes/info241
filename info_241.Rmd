...
m3 <- d[, lm(data = analysis, rating ~ applicant_gender * applicant_education + risk + applicant_gender * factor(gender, levels = c("Man", "Woman")))]
...
ggplot(subset(analysis, gender == "Man" | gender == "Woman"), aes(y = technical_scale, x = applicant_education))+
  geom_jitter(aes(color = Condition), alpha = 0.8)+
